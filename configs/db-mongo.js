...
const gracefulShutdownMongo = async (signal) => {
...
process.on('SIGINT', () => gracefulShutdownMongo('SIGINT'));
process.on('SIGTERM', () => gracefulShutdownMongo('SIGTERM'));
process.on('SIGUSR2', () => gracefulShutdownMongo('SIGUSR2'));
